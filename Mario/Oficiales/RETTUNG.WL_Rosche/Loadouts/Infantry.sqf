...
_caller addWeapon "BWA3_G36A2";
_caller addPrimaryWeaponItem "BWA3_acc_VarioRay_irlaser_black";
_caller addPrimaryWeaponItem "BWA3_30Rnd_556x45_G36_Tracer";
...
for "_i" from 1 to 4 do {_caller addItemToVest "BWA3_30Rnd_556x45_G36";};
for "_i" from 1 to 2 do {_caller addItemToVest "BWA3_30Rnd_556x45_G36_Tracer";};
for "_i" from 1 to 5 do {_caller addItemToBackpack "ACE_splint";};
for "_i" from 1 to 2 do {_caller addItemToBackpack "BWA3_30Rnd_556x45_G36_Tracer";};
...
_caller addPrimaryWeaponItem "BWA3_acc_VarioRay_irlaser_black";
_caller addPrimaryWeaponItem "BWA3_30Rnd_556x45_G36";
_caller addWeapon "BWA3_CarlGustav";
_caller addSecondaryWeaponItem "BWA3_optic_CarlGustav";
...
for "_i" from 1 to 3 do {_caller addItemToBackpack "Chemlight_green";};
for "_i" from 1 to 3 do {_caller addItemToBackpack "MiniGrenade";};
for "_i" from 1 to 3 do {_caller addItemToBackpack "BWA3_CarlGustav_HEAT";};
_caller addHeadgear "BWA3_M92_Fleck";
...
_caller addWeapon "BWA3_G36A2_AG40";
_caller addPrimaryWeaponItem "BWA3_acc_VarioRay_irlaser_black";
_caller addPrimaryWeaponItem "BWA3_30Rnd_556x45_G36";
...
for "_i" from 1 to 3 do {_caller addItemToBackpack "Chemlight_green";};
for "_i" from 1 to 3 do {_caller addItemToBackpack "MiniGrenade";};
for "_i" from 1 to 3 do {_caller addItemToBackpack "BWA3_30Rnd_556x45_G36";};
_caller addItemToBackpack "1Rnd_SmokeRed_Grenade_shell";
...
_caller addItemToBackpack "1Rnd_SmokeYellow_Grenade_shell";
_caller addItemToBackpack "1Rnd_SmokeBlue_Grenade_shell";
for "_i" from 1 to 3 do {_caller addItemToBackpack "ACE_HuntIR_M203";};
_caller addHeadgear "BWA3_M92_Fleck";
...
for "_i" from 1 to 5 do {_caller addItemToVest "BWA3_30Rnd_556x45_G36";};
...
_caller linkItem "ItemCompass";
_caller linkItem "ItemWatch";
_caller linkItem "tf_anprc152_21";
_caller linkItem "BWA3_ItemNaviPad";
_caller linkItem "NVGoggles_INDEP";
...
_radioOperatorAction = [_this select 0, "<t size='1.5' color='#00ccff'>ESPECIALISTA EN EXPLOSVIOS</t>", {
removeAllWeapons _caller;
removeAllItems _caller;
removeAllAssignedItems _caller;
removeUniform _caller;
...
_ATRiflemanAction = [_this select 0, "<t size='1.5' color='#00ccff'>FUSILERO AA</t>", {
