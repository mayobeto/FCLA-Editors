...
*/
 ...
 [] Spawn {
   ...
   [
    ...
    [[["Diablos rojos", "<t align = 'center' shadow = '1' size = '1.5' font='PuristaBold'>%1</t><br/>"], // ← Titulo emergente (Modificable)
    ["Misión 3: Operación Atardecer Rojo", "<t align = 'center' shadow = '1' size = '1' font='PuristaBold'>%1"]]] spawn BIS_fnc_typeText; // ← Subtitulo emergente (Modificable)
