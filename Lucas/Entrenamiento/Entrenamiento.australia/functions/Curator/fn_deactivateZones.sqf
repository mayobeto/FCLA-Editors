...
["FCLA", "Modificar entrenamiento", {
  ...
  {
    (_this select 0) params ["_showAmbientFlyby", "_showCompetitiveCQB", "_showShootingRange"];
    ...
    //if (!_showAmbientFlyby) then {["ENH_AmbientFlyby_Enabled", _showAmbientFlyby] call CBA_fnc_publicVariable;};
