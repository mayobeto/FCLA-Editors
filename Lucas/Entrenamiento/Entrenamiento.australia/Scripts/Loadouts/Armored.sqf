...
(_this select 0) setUserActionText [_explosivesSpecialistAction, "<t size='1.5' color='#fbd40b'>Especialista en Explosivos</t>", "<t size='1.5' color='#fbd40b'>Especialista en Explosivos</t><br/><img size='3' image='\FCLA_Interactions\Insignias\data\CEE.paa'/>"];
