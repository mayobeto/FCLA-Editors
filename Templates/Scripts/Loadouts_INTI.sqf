...
Loadouts_INTI setUserActionText [_sergeantAction , "<t size='1.5' color='#fbd40b'>Sargento</t>", "<t size='1.5' color='#fbd40b'>Sargento</t><br/><br/><img size='3' image='\FCLA_Interactions\Insignias\data\CDM.paa'/>"];
