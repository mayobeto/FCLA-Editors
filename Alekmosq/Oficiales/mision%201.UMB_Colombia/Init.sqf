...
*/
 ...
 [] Spawn {
   ...
   [
    format ["<img shadow='0.8' size='10' image='%1' />", "FCLA_Utilidades\Texturas\Otros\Presentacion.jpg"], //Tamaño y directorio de imagen
...
*/
 ...
 null = [] execVM "Scripts\Loadouts_Ejemplo.sqf"; // ← Llamada a el archivo de ejemplo de loadout
